    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            try
            {
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("Você escolheu a Floresta");
                    Console.WriteLine();
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("Você escolheu a estrada");
                    Console.WriteLine();
                    while (xEstrada < etapaEstrada)
                    {
                        ...
                        {
                            Console.WriteLine("Você não encontrou nenhum inimigo na etapa: " + xEstrada);
                            await Task.Delay(2000);
                        }
                        xEstrada++;
                    }
